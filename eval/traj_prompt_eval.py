### For uncontrollable generation evaluation ###
...
class IndividualEval(object):
    ...
    def __init__(self, horizontal_n, seq_len, interval, npy_file_path, traj_file_path1, traj_file_path2, is_interval1=False, use_grid_id1=False, is_interval2=False, use_grid_id2=False, agent_id1=False, agent_id2=False):
...
##############################################################################################################
    ...
    agent_id2=False
    #### Evaluation ####
    individualEval = IndividualEval(horizontal_n, seq_len, interval, npy_file_path, traj_file_path1, traj_file_path2, is_interval1, use_grid_id1, is_interval2, use_grid_id2, agent_id1, agent_id2)
