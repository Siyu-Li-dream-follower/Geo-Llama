...
class HOS_prompt:
    def __init__(self, npy_file_path, output_filename, horizontal_n, include_agent_id=True, use_grid_id=False, is_interval=False, 
                 event_permute=False, feature_permute=False, departure_flag=False, departure_only_flag=False):
        ...
        self.departure_flag = departure_flag
        self.departure_only_flag = departure_only_flag
    ...
    def process_events(self):
        ...
        for key, events in grouped_data.items():
            ...
            for event in sampled_events:
                ...
                elif self.departure_only_flag:    
                    time_choice = 'departure'
                else:
                    time_choice ='arrival'
...
if __name__ == '__main__':
    ...
    output_filename = ''
    horizontal_n = 200
    hos_sampler = HOS_prompt(npy_file_path, output_filename, horizontal_n, include_agent_id=False, use_grid_id=True, 
                             is_interval=True, event_permute=True, feature_permute=False, departure_flag=False, departure_only_flag=True)
